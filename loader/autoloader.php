...
// 
 ...
 spl_autoload_register(function ($className) {
    ...
    $classPaths = [
        ...
        realpath(__DIR__ . '/../app/model/3d') . DIRECTORY_SEPARATOR,
        realpath(__DIR__ . '/../app/model/fast3') . DIRECTORY_SEPARATOR,
        realpath(__DIR__ . '/../app/model/pk10') . DIRECTORY_SEPARATOR,
        realpath(__DIR__ . '/../app/model/mark6') . DIRECTORY_SEPARATOR,
        realpath(__DIR__ . '/../app/controller/5d') . DIRECTORY_SEPARATOR,
        realpath(__DIR__ . '/../app/controller/3d') . DIRECTORY_SEPARATOR,
        realpath(__DIR__ . '/../app/controller/fast3') . DIRECTORY_SEPARATOR,
        realpath(__DIR__ . '/../app/controller/pk10') . DIRECTORY_SEPARATOR,
    ];
